...
public class UpdateZlapanyOdUkrywajacego extends AsyncTask<MyTaskParams_updateZlapany, Void, Void> {
    ...
    private static String url_create_product = "http://kinwsm2017.cba.pl/podchody/update_zlapany_od_ukrywajacego.php";
    ...
    public UpdateZlapanyOdUkrywajacego(int ID_Gracza){
